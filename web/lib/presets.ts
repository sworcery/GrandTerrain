...
export const PRESETS: Preset[] = [
  ...
  },
  {
    ...
    config: {
      terrain: { mountainHeightScale: 8.0, continentalScale: 1.5, erosionStrength: 2.0, seaLevel: 100 },
  ...
  },
  {
    ...
    config: {
      terrain: { mountainHeightScale: 4.0, continentalScale: 2.0, erosionStrength: 0.3, seaLevel: 80 },
  ...
  },
  {
    ...
    config: {
      terrain: { mountainHeightScale: 3.0, continentalScale: 0.8, erosionStrength: 1.5, seaLevel: 160 },
  ...
  },
  {
    ...
    config: {
      terrain: { mountainHeightScale: 6.0, continentalScale: 1.2, erosionStrength: 0.8, seaLevel: 110 },
